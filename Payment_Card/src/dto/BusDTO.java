...
public class BusDTO implements SuperEntity {
    private String BID;
    private String No;
    private String Name;
    ...
    public BusDTO(String BID, String no, String name, String route, String date, String facilities, String type, String ownerName, String ownerNIC, String ownerAddress, String ownerContactNo) {
        this.BID = BID;
        No = no;
        Name = name;
        Route = route;
