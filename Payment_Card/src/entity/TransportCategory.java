...
public class TransportCategory implements SuperEntity {
    private String TID;
    ...
    public TransportCategory(String TID, String destination, double peoplePrice, double peopleItemPrice, double itemPrice, double peoplePetPrice) {
        this.TID = TID;
